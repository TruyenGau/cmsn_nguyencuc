...
const eventName = 'Chúc Mừng Sinh Nhật Cúc 29-08 ';
const titleCard = '';
const contentCard = 'Chúc Cúc có sinh nhật vui vẻ,  tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với Cúc trong hôm nay và cả những ngày sau';
